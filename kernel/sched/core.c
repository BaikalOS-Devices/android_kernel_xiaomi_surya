...
/* Min allowed minimum utilization */
unsigned int sysctl_sched_uclamp_util_min = 0; //SCHED_CAPACITY_SCALE;
 ...
 * above.
 */
unsigned int sysctl_sched_uclamp_util_min_rt_default = 0; //SCHED_CAPACITY_SCALE;
